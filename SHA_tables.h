...
*/
#pragma once
const uint32_t k0_1[] = { 0x5A827999, 0x6ED9EBA1, 0x8F1BBCDC, 0xCA62C1D6 }; // constants

const uint32_t k224_256[] = { // round constants
...
const uint64_t k384_512[] = { // round constants
